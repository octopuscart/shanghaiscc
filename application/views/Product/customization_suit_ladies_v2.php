                            ...
                            <div class="tab-content">
                                ...
                                <div class="{{$index === 0?'active':''}} frame1" ng-repeat="fab in cartFabrics" id="fabric_{{fab.product_id}}">
                                    ...
                                    <div class="fontview_custom customization_block animated zoom "  ng-if="screencustom.view_type == 'front'" >
                                        ...
                                        <img src="<?php echo base_url(); ?>assets/images/suit_elements/suittype_ladis.png" class="fixpos animated" >
                                    ...
                                    <div class="backview_custom customization_block zoom animated " ng-if="screencustom.view_type == 'skirt'">

                                        <img src="<?php echo base_url(); ?>assets/images/pant_elements/ladisskirtbase.png" class="fixpos animated">

                                        <!--font-->
                                        <img src="<?php echo base_url(); ?>assets/images/pant_elements/{{img}}" class="fixpos animated" ng-repeat="img in selecteElements[fab.product_id]['Skirt Length'].elements">
                                        <img src="<?php echo base_url(); ?>assets/images/pant_elements/{{selecteElements[fab.product_id]['Vent'].venttype}}_{{img}}" class="fixpos animated" ng-repeat="img in selecteElements[fab.product_id]['Skirt Length'].elements" ng-if="selecteElements[fab.product_id]['Vent'].venttype">
                                    ...
                                    <div class="backview_custom customization_block zoom animated " ng-if="screencustom.view_type == 'pant'">
                                        ...
                                        <img src="<?php echo base_url(); ?>assets/images/pant_elements/base_ladis.png" class="fixpos animated">
                                    ...
                                    <div class="backview_custom customization_block zoom animated " ng-if="screencustom.view_type == 'pantback'">
                                        ...
                                        <img src="<?php echo base_url(); ?>assets/images/pant_elements/base_ladis_back.png" class="fixpos animated">
